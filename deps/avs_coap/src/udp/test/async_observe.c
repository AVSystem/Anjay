...
#define NOTIFY_PAYLOAD "Notifaj"
    ...
    static const size_t NUM_NOTIFICATIONS = COAP_UDP_NOTIFY_CACHE_SIZE;
...
// Not specified in RFC7252 and RFC7641, but specified in
// draft-ietf-core-object-security-16. Another request with the same token
// shouldn't affect already registered observation with the same token.
