...
**EST-coaps** (`RFC 9148
<https://www.rfc-editor.org/rfc/rfc9148.html>`_, also
...
.. important::
    EST requires at least LwM2M version 1.1.

    While EST support was present in LwM2M 1.0, it was not fully robust until
    LwM2M 1.1 introduced the Certificate Usage resource in the Security Object
    and the Trust Store concept.
...
.. note::
    ...
    Anjay generates a new one and send the CRS for a certificate related to the new key.
...
* ``/est/sren`` requests are issued 30 days before the certificate expiration
  ...
  has passed, whichever is later. The margin is then divided to 10 equal parts
  and if the operation fails, next attempt is scheduled after  ``margin / 10``.
...
<../api/api_generated/function_core_8h_1a02394aecc7e6c616ced0ed6157da8ff7.html>`_ function can be useful
for this purpose. It is intended to be used in a similar manner to functions
such as `anjay_security_object_is_modified()
<../api/api_generated/function_security_8h_1a25a9fbd4f84f05a8a2ce50f526c7bc77.html>`_, however it will
...
* `trust_store_certs
  <../api/api_generated/structanjay__configuration.html#_CPPv4N19anjay_configuration17trust_store_certsE>`_
  ...
  <../api/api_generated/structanjay__security__instance__t.html#_CPPv4N25anjay_security_instance_t17certificate_usageE>`_)
  is set to 0 or 1, used before a new one is obtained via ``/est/crts``

  * See also related: `use_system_trust_store
    <../api/api_generated/structanjay__configuration.html#_CPPv4N19anjay_configuration22use_system_trust_storeE>`_
    and `trust_store_crls
    <../api/api_generated/structanjay__configuration.html#_CPPv4N19anjay_configuration16trust_store_crlsE>`_

* `est_reenroll_config
  <../api/api_generated/structanjay__configuration.html#_CPPv4N19anjay_configuration19est_reenroll_configE>`_
  ...
  <../api/api_generated/structanjay__est__reenroll__config__t.html#_CPPv427anjay_est_reenroll_config_t>`_
...
* `est_cacerts_policy
  ...
  <../api/api_generated/enum_core_8h_1a150879e082c4c2355393dab23bacddba.html#_CPPv426anjay_est_cacerts_policy_t>`_
...
* `est_engine_key_address
  <../api/api_generated/structanjay__configuration.html#_CPPv4N19anjay_configuration22est_engine_key_addressE>`_
...
* `est_engine_cert_address
  <../api/api_generated/structanjay__configuration.html#_CPPv4N19anjay_configuration23est_engine_cert_addressE>`_
...
* `est_engine_cacerts_address_gen_cb
  <../api/api_generated/structanjay__configuration.html#_CPPv4N19anjay_configuration33est_engine_cacerts_address_gen_cbE>`_
  ...
  * `est_engine_cacerts_address_gen_cb_arg
    <../api/api_generated/structanjay__configuration.html#_CPPv4N19anjay_configuration37est_engine_cacerts_address_gen_cb_argE>`_
  ...
  * The returned string is copied by the library, so reusing the same buffer for
    ...
    <../api/api_generated/typedef_core_8h_1a9d019635ff7787fab2b88b29f37bbdb6.html#_CPPv437anjay_est_engine_cacert_address_gen_t>`_
    for details on this callback's semantics.
