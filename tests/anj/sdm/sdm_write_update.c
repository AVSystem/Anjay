...
AVS_UNIT_TEST(sdm_write_update, write_handler) {
    TEST_INIT(dm, obj);
...
AVS_UNIT_TEST(sdm_write_update, write_no_handler) {
    TEST_INIT(dm, obj);
...
AVS_UNIT_TEST(sdm_write_update, write_string_in_chunk) {
    TEST_INIT(dm, obj);
...
AVS_UNIT_TEST(sdm_write_update, multi_res_write) {
    TEST_INIT(dm, obj);
    ...
    record.path = FLUF_MAKE_RESOURCE_INSTANCE_PATH(1, 1, 4, 3);
    AVS_UNIT_ASSERT_SUCCESS(sdm_write_entry(&dm, &record));
    AVS_UNIT_ASSERT_SUCCESS(sdm_operation_end(&dm));
    AVS_UNIT_ASSERT_TRUE(call_res == &res_1[4]);
    AVS_UNIT_ASSERT_TRUE(call_res_inst == &res_inst_3);
    AVS_UNIT_ASSERT_TRUE(call_value == &record.value);
...
AVS_UNIT_TEST(sdm_write_update, multi_res_write_no_handler) {
    TEST_INIT(dm, obj);

    fluf_uri_path_t path = FLUF_MAKE_RESOURCE_INSTANCE_PATH(1, 1, 5, 1);
    fluf_io_out_entry_t record = {
        .type = FLUF_DATA_TYPE_INT,
        .value.int_value = 555555,
        .path = FLUF_MAKE_RESOURCE_INSTANCE_PATH(1, 1, 5, 1)
    };
...
AVS_UNIT_TEST(sdm_write_update, bootstrap_write) {
    TEST_INIT(dm, obj);
    ...
    AVS_UNIT_ASSERT_SUCCESS(sdm_operation_begin(
            &dm, FLUF_OP_DM_WRITE_PARTIAL_UPDATE, true, &path));
    AVS_UNIT_ASSERT_SUCCESS(sdm_write_entry(&dm, &record_1));
    AVS_UNIT_ASSERT_SUCCESS(sdm_operation_end(&dm));
...
AVS_UNIT_TEST(sdm_write_update, multi_res_write_create) {
    TEST_INIT(dm, obj);
    ...
    AVS_UNIT_ASSERT_TRUE(res_insts[1] == &res_inst_1);
    AVS_UNIT_ASSERT_TRUE(res_insts[2] == &res_inst_new_2);
    AVS_UNIT_ASSERT_TRUE(res_insts[3] == &res_inst_3);
    AVS_UNIT_ASSERT_TRUE(res_insts[4] == &res_inst_new_3);
    AVS_UNIT_ASSERT_TRUE(res_insts[0]->riid == 0 && res_insts[1]->riid == 1
                         && res_insts[2]->riid == 2 && res_insts[3]->riid == 3
                         && res_insts[4]->riid == 8);
}

AVS_UNIT_TEST(sdm_write_update, error_type) {
    TEST_INIT(dm, obj);
...
AVS_UNIT_TEST(sdm_write_update, error_no_writable) {
    TEST_INIT(dm, obj);
...
AVS_UNIT_TEST(sdm_write_update, error_path) {
    TEST_INIT(dm, obj);
    fluf_io_out_entry_t record = {
        .type = FLUF_DATA_TYPE_INT,
...
AVS_UNIT_TEST(sdm_write_update, error_path_multi_instance) {
    TEST_INIT(dm, obj);
    fluf_io_out_entry_t record = {
        .type = FLUF_DATA_TYPE_INT,
...
AVS_UNIT_TEST(sdm_write_update, handler_error) {
    TEST_INIT(dm, obj);
...
AVS_UNIT_TEST(sdm_write_update, handler_error_2) {
    TEST_INIT(dm, obj);
    ...
    AVS_UNIT_ASSERT_SUCCESS(sdm_operation_begin(
            &dm, FLUF_OP_DM_WRITE_PARTIAL_UPDATE, false, &path));
    AVS_UNIT_ASSERT_EQUAL(sdm_write_entry(&dm, &record), -2);
    AVS_UNIT_ASSERT_EQUAL(sdm_operation_end(&dm), -2);
...
AVS_UNIT_TEST(sdm_write_update, string_in_chunk_error) {
    TEST_INIT(dm, obj);
