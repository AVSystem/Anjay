...
static inline void _anjay_log_feature_list(void) {
...
#ifdef ANJAY_EST_CSR_BUFFER_SIZE
    _anjay_log(anjay, TRACE, "ANJAY_EST_CSR_BUFFER_SIZE = " AVS_QUOTE_MACRO(ANJAY_EST_CSR_BUFFER_SIZE));
#else // ANJAY_EST_CSR_BUFFER_SIZE
    _anjay_log(anjay, TRACE, "ANJAY_EST_CSR_BUFFER_SIZE = OFF");
#endif // ANJAY_EST_CSR_BUFFER_SIZE
#ifdef ANJAY_EST_SECRET_KEY_BUFFER_SIZE
    _anjay_log(anjay, TRACE, "ANJAY_EST_SECRET_KEY_BUFFER_SIZE = " AVS_QUOTE_MACRO(ANJAY_EST_SECRET_KEY_BUFFER_SIZE));
#else // ANJAY_EST_SECRET_KEY_BUFFER_SIZE
    _anjay_log(anjay, TRACE, "ANJAY_EST_SECRET_KEY_BUFFER_SIZE = OFF");
#endif // ANJAY_EST_SECRET_KEY_BUFFER_SIZE
    _anjay_log(anjay, TRACE, "ANJAY_HOLDOFF_JITTER_RANDOM_FACTOR = " AVS_QUOTE_MACRO(ANJAY_HOLDOFF_JITTER_RANDOM_FACTOR));
    ...
    _anjay_log(anjay, TRACE, "ANJAY_WITH_UNSECURE_CONNECTIONS = ON");
#else // ANJAY_WITH_UNSECURE_CONNECTIONS
    _anjay_log(anjay, TRACE, "ANJAY_WITH_UNSECURE_CONNECTIONS = OFF");
    ...
    _anjay_log(anjay, TRACE, "AVS_COMMONS_WITH_LEGACY_SSL_VERSIONS = ON");
#else // AVS_COMMONS_WITH_LEGACY_SSL_VERSIONS
    _anjay_log(anjay, TRACE, "AVS_COMMONS_WITH_LEGACY_SSL_VERSIONS = OFF");
