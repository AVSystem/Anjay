...
.. code-block:: c
    ...
    /**
     * Generated by anjay_codegen.py on 2019-12-02 15:30:14
     *
    ...
    static some_object_name_instance_t *find_instance(const some_object_name_t *obj,
                                                      anjay_iid_t iid) {
    ...
    const anjay_dm_object_def_t **some_object_name_object_create(void) {
        some_object_name_t *obj = (some_object_name_t *) avs_calloc(1, sizeof(some_object_name_t));
        if (!obj) {
            return NULL;
        }
        obj->def = &OBJ_DEF;
